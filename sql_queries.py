...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays(songplay_id SERIAL PRIMARY KEY, start_time TIMESTAMPTZ, user_id INT, level VARCHAR, song_id VARCHAR, artist_id VARCHAR, session_id VARCHAR, location VARCHAR, user_agent VARCHAR);""")
...
time_table_create = ("""CREATE TABLE IF NOT EXISTS time(start_time TIMESTAMPTZ PRIMARY KEY, hour INT, day INT, week INT, month INT, year INT, weekday INT)""")
